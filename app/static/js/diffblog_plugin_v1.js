function create_iframe(plugin_public_api_key, blog_post_url) {
    ...
    var iframe_url = "/plugin/iframe?plugin_public_api_key=" + plugin_public_api_key + "&url_encoded_blog_post_url=" + url_encoded_blog_post_url;
    iframe.setAttribute("src", iframe_url);
    iframe.setAttribute("style", "width: 1px; min-width: 100%; border: none; user-select: none; visibility: visible;");
    const iframe_holder = document.createElement("div");
    plugin_script.parentNode.insertBefore(iframe_holder, plugin_script.nextSibling);
